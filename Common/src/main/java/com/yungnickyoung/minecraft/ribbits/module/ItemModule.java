...
public class ItemModule {
    ...
    public static final AutoRegisterItem RIBBIT_NITWIT_SPAWN_EGG = AutoRegisterItem.of(() -> new RibbitSpawnEggItem(EntityTypeModule.RIBBIT.get(), RibbitProfessionModule.NITWIT, 0xb3c35b, 0x769b4f, new Item.Properties()));

    @AutoRegister("ribbit_fisherman_spawn_egg")
    public static final AutoRegisterItem RIBBIT_FISHERMAN_SPAWN_EGG = AutoRegisterItem.of(() -> new RibbitSpawnEggItem(EntityTypeModule.RIBBIT.get(), RibbitProfessionModule.FISHERMAN, 0xb3c35b, 0x956c41, new Item.Properties()));

    @AutoRegister("ribbit_gardener_spawn_egg")
    public static final AutoRegisterItem RIBBIT_GARDENER_SPAWN_EGG = AutoRegisterItem.of(() -> new RibbitSpawnEggItem(EntityTypeModule.RIBBIT.get(), RibbitProfessionModule.GARDENER, 0xb3c35b, 0x6b4434, new Item.Properties()));

    @AutoRegister("ribbit_merchant_spawn_egg")
    public static final AutoRegisterItem RIBBIT_MERCHANT_SPAWN_EGG = AutoRegisterItem.of(() -> new RibbitSpawnEggItem(EntityTypeModule.RIBBIT.get(), RibbitProfessionModule.MERCHANT, 0xb3c35b, 0x5b3f28, new Item.Properties()));
