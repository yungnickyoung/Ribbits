...
import com.yungnickyoung.minecraft.ribbits.mixin.mixins.accessor.SinglePoolElementAccessor;
...
public class PieceInHorizontalDirectionCondition extends StructureCondition {
    private static final ResourceLocation ALL = ResourceLocation.fromNamespaceAndPath(RibbitsCommon.MOD_ID, "all");
