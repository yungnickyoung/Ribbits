...
import com.yungnickyoung.minecraft.ribbits.mixin.mixins.accessor.BoundingBoxAccessor;
import com.yungnickyoung.minecraft.ribbits.mixin.mixins.accessor.StructureTemplatePoolAccessor;
...
public class JigsawStructureAssembler {
    ...
    private static ResourceKey<StructureTemplatePool> readPoolKey(StructureTemplate.JigsawBlockInfo jigsawBlockInfo) {
        return ResourceKey.create(Registries.TEMPLATE_POOL, jigsawBlockInfo.pool().location());
    }
    ...
    public static class Settings {
        ...
        public boolean isInBounds(int y) {
            ...
            return y <= levelHeightAccessor.getMaxY() - dimensionPadding.top();
        }
    }
}
