...
import com.yungnickyoung.minecraft.ribbits.mixin.mixins.accessor.NoiseChunkAccessor;
...
public class EnhancedBeardifierHelper {
    ...
    public static Beardifier forStructuresInChunk(StructureManager structureManager, ChunkPos chunkPos, Beardifier original) {
        ...
        Beardifier newBeardifier = new Beardifier(original.pieces, original.junctions, original.affectedBox);
