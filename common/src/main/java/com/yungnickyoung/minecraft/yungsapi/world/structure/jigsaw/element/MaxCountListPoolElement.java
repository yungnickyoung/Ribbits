...
import com.yungnickyoung.minecraft.ribbits.mixin.mixins.accessor.ListPoolElementAccessor;
...
public class MaxCountListPoolElement extends ListPoolElement implements IMaxCountJigsawPoolElement {
    ...
    public StructurePoolElementType<?> getType() {
        return StructurePoolElementTypeModule.MAX_COUNT_LIST_ELEMENT.get();
    }
